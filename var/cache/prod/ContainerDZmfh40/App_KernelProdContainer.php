...
class App_KernelProdContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\GuiltyController' => 'getGuiltyControllerService',
    ...
    {
        return $this->privates['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4ZsryP1KSs', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            ...
            yield 2 => ($this->privates['security.authentication.provider.dao.reg'] ?? $this->load('getSecurity_Authentication_Provider_Dao_RegService'));
        }, 3), true);
    ...
    protected function getSecurity_Firewall_MapService()
    {
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'security.firewall.map.context.reg' => ['privates', 'security.firewall.map.context.reg', 'getSecurity_Firewall_Map_Context_RegService', true],
        ], [
            'security.firewall.map.context.main' => '?',
            'security.firewall.map.context.reg' => '?',
        ]), new RewindableGenerator(function () {
            yield 'security.firewall.map.context.main' => NULL;
            yield 'security.firewall.map.context.reg' => ($this->privates['.security.request_matcher.3UEFixr'] ?? ($this->privates['.security.request_matcher.3UEFixr'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/')));
        }, 2));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'security.reg._indexed_authenticators' => [
