...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
  ...
  'isActive' => NULL,
    ...
    {
        unset($this->username, $this->email, $this->password, $this->roles, $this->isActive);
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'username', 'email', 'plainPassword', 'password', 'roles', 'isActive'];
        }

        return ['__isInitialized__', 'id', 'plainPassword'];
    }
